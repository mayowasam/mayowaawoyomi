  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 img-container pointer-events-none z-10">
        <Image src="/window.png" alt="" fill className="object-cover" />
      </div>

      {/* HERO TEXT */}
      <div
        className="absolute inset-0 z-20 h-screen flex flex-col md:flex-row items-center justify-center px-12 wrapper"
        style={{ opacity: 0, visibility: "hidden" }} // hide on load
      >
        <div className="left-side max-w-3xl space-y-4 text-white">
          <p className="md:text-8xl font-bold">
            Mayowa{" "}
            <span className="md:text-4xl font-semibold align-top">Samuel</span>
          </p>
          <p className="text-right md:text-8xl font-bold">Awoyomi</p>

          <p className="mt-6 max-w-md font-mono ">
        ...
        <a href="about" className="text-white right-side md:ml-auto text-lg mt-16 md:mt-0">
          More About Me →
        </a>
      </div>
    </section>
